...
const highlights = [
  ...
  'تجربة عربية واضحة وسهلة',
  'حساب آمن لإدارة المحتوى التعليمي',
]

export function AuthVisualLayout({ title, description, footer, className, children }: AuthVisualLayoutProps) {
  return (
        ...
        <aside className="hidden min-h-screen flex-col justify-between overflow-hidden bg-gradient-to-br from-[#6949ff] via-[#7c3aed] to-[#24135f] p-8 text-white lg:flex">
          ...
          <div className="relative z-10 mx-auto flex w-full max-w-xl flex-1 items-center justify-center py-10">
            <div className="relative w-full">
              ...
              <img src="/auth-quizy.png" alt="Quizy auth" className="relative mx-auto max-h-[520px] w-full object-contain drop-shadow-[0_30px_70px_rgba(15,23,42,0.35)]" />
            </div>
          </div>
          ...
          <div className="relative z-10 space-y-5">
            <div className="max-w-xl space-y-3">
              ...
              <h2 className="text-3xl font-bold leading-relaxed">ابدأ إدارة Quizy من حساب واضح وآمن.</h2>
              <p className="text-sm leading-7 text-white/75">
                واجهة مصممة بروح التطبيق: بسيطة، عربية، ودودة، ومناسبة لإدارة المحتوى التعليمي بسرعة.
              </p>
            </div>
          ...
          <div className={cn('w-full max-w-[480px]', className)}>
            ...
            <div className="overflow-hidden rounded-[2rem] border border-white/80 bg-white/90 p-5 shadow-[0_24px_80px_rgba(80,62,160,0.18)] backdrop-blur sm:p-7">
              <div className="mb-6 space-y-2 text-center">
                <p className="text-xs font-bold uppercase tracking-[0.32em] text-[#6949ff]">Quizy Admin</p>
              ...
              {footer ? <div className="mt-6 border-t border-slate-100 pt-5 text-center">{footer}</div> : null}
            </div>
          </div>
        </div>
      </section>
