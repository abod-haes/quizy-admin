...
export function normalizeCountryCallingCode(countryCallingCode?: string | null): string {
  const cleanCode = String(countryCallingCode || DEFAULT_COUNTRY_CALLING_CODE).replace(/\s/g, '')
