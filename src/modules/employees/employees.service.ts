...
export const employeesService = {
  ...
  create: (payload: CreateAdminEmployeeInput) =>
    api.post<AdminEmployee, CreateAdminEmployeeInput>(API_ENDPOINTS.employees.create, payload),
  ...
  resendInvitation: (id: string) => api.post<{ sent: boolean }>(API_ENDPOINTS.employees.resendInvitation(id)),
